...
For example, if a commit contains `kate_wakatime/src/main.cpp`, and `CHANGELOG.md`, the component
...
- Header file `include/kate_wakatime/util.h` → `util:`.
